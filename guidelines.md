...
Alternatively, ensure the build requirements for the recipe include
`perl-app-cpanminus`, and the `build.sh` script can be simplified. An example
of this is [perl-time-hires](recipes/perl-time-hires).
