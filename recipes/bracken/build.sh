...
sed -i.bak '1 s|^.*$|#!/usr/bin/env python|g' est_abundance.py
...
chmod +x $PREFIX/bin/count-kmer-abundances.pl $PREFIX/bin/est_abundance.py $PREFIX/bin/generate_kmer_distribution.py
