...
(cd kent/src/hg/ratStuff/mafSplit && make CC="${CC}" CXX="${CXX}" CFLAGS="${CFLAGS}" CXXFLAGS="${CXXFLAGS}" -j "${CPU_COUNT}")
cp bin/mafSplit "${PREFIX}/bin"
chmod 0755 "${PREFIX}/bin/mafSplit"
