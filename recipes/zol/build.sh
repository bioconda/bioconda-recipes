...
sha256sum gravis_v0.1.1.tar.gz
sha256sum gravis_v0.1.1.tar.gz | grep -q "d8a8b09a23522ab746eea740adc05f22cb6a1d5190c1b64ee4f304e62b37268b" && echo "Matching SHA256 for gravis" || (echo "Mismatch SHA256 for gravis" && exit 1)
