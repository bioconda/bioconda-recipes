...
(cd kent/src/hg/utils/bigMafToMaf && make CC="${CC}" CXX="${CXX}" CFLAGS="${CFLAGS}" CXXFLAGS="${CXXFLAGS}" -j "${CPU_COUNT}")
cp bin/bigMafToMaf "${PREFIX}/bin"
chmod 0755 "${PREFIX}/bin/bigMafToMaf"
