...
my @items = (
    ...
    ["Bio::Assembly::Contig", "1.007001"],
    ["Bio::Assembly::ContigAnalysis", undef],
    ["Bio::Assembly::IO", undef],
    ["Bio::Assembly::IO::ace", "1.007001"],
    ...
    ["Bio::DB::GFF::Adaptor::berkeleydb", "1.007001"],
    ["Bio::DB::GFF::Adaptor::biofetch", "1.007001"],
    ["Bio::DB::GFF::Adaptor::dbi", "1.007001"],
    ["Bio::DB::GFF::Adaptor::dbi::caching_handle", undef],
    ["Bio::DB::GFF::Adaptor::dbi::iterator", "1.007001"],
    ["Bio::DB::GFF::Adaptor::memory", "1.007001"],
    ["Bio::DB::GFF::Adaptor::memory::feature_serializer", undef],
    ["Bio::DB::GFF::Adaptor::memory::iterator", "1.007001"],
    ...
    ["Bio::DB::GFF::Util::Binning", "1.007001"],
    ["Bio::DB::GFF::Util::Rearrange", "1.007001"],
    ...
    ["Bio::DB::SeqFeature::Store", "1.007001"],
    ...
    ["Bio::Index::Hmmer", "1.007001"],
    ["Bio::Index::Qual", undef],
    ["Bio::Index::Stockholm", undef],
    ["Bio::Index::SwissPfam", undef],
    ["Bio::Index::Swissprot", undef],
    ["Bio::LiveSeq::AARange", "1.007001"],
    ["Bio::LiveSeq::Chain", "1.007001"],
    ["Bio::LiveSeq::ChainI", "1.007001"],
    ...
    ["Bio::Search::Hit::BlastHit", "1.007001"],
    ...
    ["Bio::Search::SearchUtils", "1.007001"],
    ...
    ["Bio::SeqFeature::Collection", "1.007001"],
    ...
    #["Bio::DB::GFF::Adaptor::dbi::mysql", "1.007001"],
    ...
    #["Bio::Tools::dpAlign", "1.007001"],
    #["Bio::SearchDist", "1.007001"],
    #["Bio::Tools::AlignFactory", "1.007001"],
    #["Bio::Tools::pSW", undef],
);
