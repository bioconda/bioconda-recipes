...
rm -rf $PREFIX/bin/batch_cdgc.tar.gz $PREFIX/bin/candidate_locus.tar.gz
...
curl -o $PREFIX/bin/DeepMEI_model/weights/val_best_model/variables/variables.data-00000-of-00001ad https://github.com/xuxif/DeepMEI/raw/main/DeepMEI/DeepMEI_model/weights/val_best_model/variables/variables.data-00000-of-00001ad
