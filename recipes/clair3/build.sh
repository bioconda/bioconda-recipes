...
make CC=${GCC} CXX=${GXX}  PREFIX=${PREFIX} CFLAGS="-fpic -std=c99 -Og -g -I ${PREFIX}/include -L ${PREFIX}/lib" CPPFLAGS="-std=c++11 -Wall -Og -g -I ${PREFIX}/include -L ${PREFIX}/lib -Wl,-rpath=${PREFIX}/lib"
