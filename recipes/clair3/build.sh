...
make CC=${GCC} CXX=${GXX}  PREFIX=${PREFIX} CFLAGS="-fpic -std=c99 -O0 -g -I ${PREFIX}/include -L ${PREFIX}/lib" CPPFLAGS="-std=c++11 -Wall -O0 -g -I ${PREFIX}/include -L ${PREFIX}/lib -Wl,-rpath=${PREFIX}/lib"
