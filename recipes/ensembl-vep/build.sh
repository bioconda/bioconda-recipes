...
# Use insecure CURL
sed -i.bak 's/curl --location/curl -k --location/' INSTALL.pl
...
rm -rf t/
# Install plugins
curl -k -o CADD.pm https://raw.githubusercontent.com/Ensembl/VEP_plugins/release/87/CADD.pm
curl -k -o dbNSFP.pm https://raw.githubusercontent.com/Ensembl/VEP_plugins/release/87/dbNSFP.pm
curl -k -o MaxEntScan.pm https://raw.githubusercontent.com/Ensembl/VEP_plugins/release/87/MaxEntScan.pm
curl -k -o GeneSplicer.pm https://raw.githubusercontent.com/Ensembl/VEP_plugins/release/87/GeneSplicer.pm
curl -k -o dbscSNV.pm https://raw.githubusercontent.com/Ensembl/VEP_plugins/release/87/dbscSNV.pm
curl -k -o LoF.pm https://raw.githubusercontent.com/konradjk/loftee/master/LoF.pm
curl -k -o splice_module.pl https://raw.githubusercontent.com/konradjk/loftee/master/splice_module.pl
