...
cmake -DCMAKE_POLICY_VERSION_MINIMUM=3.5 -H. -Bbuild -DCMAKE_BUILD_TYPE=Generic -DEXTRA_FLAGS='-march=sandybridge -Ofast'
cmake -DCMAKE_POLICY_VERSION_MINIMUM=3.5 --build build --verbose
mkdir -p $PREFIX/bin
mv bin/* $PREFIX/bin
