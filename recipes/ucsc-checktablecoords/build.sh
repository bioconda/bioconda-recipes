...
(cd kent/src/hg/checkTableCoords && make CC="${CC}" CXX="${CXX}" CFLAGS="${CFLAGS}" CXXFLAGS="${CXXFLAGS}" -j "${CPU_COUNT}")
cp bin/checkTableCoords "${PREFIX}/bin"
chmod 0755 "${PREFIX}/bin/checkTableCoords"
