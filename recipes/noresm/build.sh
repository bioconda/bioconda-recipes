...
patch  ${PREFIX}/cime/config/noresm/machines/config_machines.xml ${RECIPE_DIR}/config_machines_xml.patch
patch  ${PREFIX}/cime/config/noresm/machines/config_compilers.xml ${RECIPE_DIR}/config_compilers_xml.patch
