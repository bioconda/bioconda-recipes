...
for bin in krakenhll krakenhll-build krakenhll-download krakenhll-extract-reads krakenhll-filter krakenhll-mpa-report krakenhll-report krakenhll-translate build_taxdb read_merger.pl; do
