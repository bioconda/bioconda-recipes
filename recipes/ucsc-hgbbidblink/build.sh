...
(cd kent/src/hg/makeDb/hgBbiDbLink && make CC="${CC}" CXX="${CXX}" CFLAGS="${CFLAGS}" CXXFLAGS="${CXXFLAGS}" -j "${CPU_COUNT}")
cp bin/hgBbiDbLink "${PREFIX}/bin"
chmod 0755 "${PREFIX}/bin/hgBbiDbLink"
