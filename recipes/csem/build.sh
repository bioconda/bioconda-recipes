...
# --- Fix Perl shebangs to use env-based lookup ---
sed -i "1s|#!/usr/bin/perl|#!/usr/bin/env perl|" "${PREFIX}/bin/run-csem"
sed -i "1s|#!/usr/bin/perl|#!/usr/bin/env perl|" "${PREFIX}/bin/csem-generate-input"
