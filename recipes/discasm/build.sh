...
cp -R $SRC_DIR/DISCASM $SRC_DIR/PerLib $SRC_DIR/SciEDPipeR $SRC_DIR/testing $SRC_DIR/util $DISCASM_INSTALL_DIR
...
echo "$DISCASM_INSTALL_DIR/DISCASM \$@" >> $PREFIX/bin/STAR-Fusion
