...
cp COPYING README WekaManual.pdf changelogs data doc documentation.css documentation.html remoteExperimentServer.jar weka-src.jar weka.gif weka.ico weka.jar wekaexamples.zip $PACKAGE_HOME
