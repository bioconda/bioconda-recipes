...
# Check for latest compatible version of the static config when updating the recipe on
...
sed -i 's,\"Static\": \"/enadisk/maison/lamouche/dev_vcf2circos/Static\"\,,\"Static\": \"$(pwd)/Static\"\,,' Static/options.json
