...
cd  ${PREFIX}/bin
sed -i "/^use Getopt::Long/cuse Getopt::Long;\\nuse lib ${PREFIX}\/bin\;" tRNAscan-SE
sed -i "/^our \$bindir/cour bindir = ${PREFIX}\/bin\;" tRNAscan-SE
sed -i "/^our \$lib_dir/cour lib_dir = ${PREFIX}\/bin\/tRNAscanSE\;" tRNAscan-SE
