...
(cd kent/src/utils/textHistogram && make CC="${CC}" CXX="${CXX}" CFLAGS="${CFLAGS}" CXXFLAGS="${CXXFLAGS}" -j "${CPU_COUNT}")
cp bin/textHistogram "${PREFIX}/bin"
chmod 0755 "${PREFIX}/bin/textHistogram"
