...
(cd kent/src/utils/raToLines/linesToRa && make CC="${CC}" CXX="${CXX}" CFLAGS="${CFLAGS}" CXXFLAGS="${CXXFLAGS}" -j "${CPU_COUNT}")
cp bin/linesToRa "${PREFIX}/bin"
chmod 0755 "${PREFIX}/bin/linesToRa"
