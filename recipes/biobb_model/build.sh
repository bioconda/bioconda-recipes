...
cp $SP_DIR/biobb_model/model/fix_backbone.py $PREFIX/bin/fix_chirality

chmod u+x $SP_DIR/biobb_model/model/fix_amides.py
cp $SP_DIR/biobb_model/model/fix_backbone.py $PREFIX/bin/fix_amides

chmod u+x $SP_DIR/biobb_model/model/checking_log.py
cp $SP_DIR/biobb_model/model/fix_backbone.py $PREFIX/bin/checking_log
