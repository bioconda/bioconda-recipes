...
canu -p asm -d asm useGrid=false genomeSize=21k -fast maxMemory=4 maxThreads=2 mhapMemory=1 corThreads=2 redThreads=2 redMemory=4 oeaMemory=4 -nanopore lambda_ont.fasta.gz
