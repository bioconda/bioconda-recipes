...
(cd kent/src/utils/newPythonProg && make CC="${CC}" CXX="${CXX}" CFLAGS="${CFLAGS}" CXXFLAGS="${CXXFLAGS}" -j "${CPU_COUNT}")
cp bin/newPythonProg "${PREFIX}/bin"
chmod 0755 "${PREFIX}/bin/newPythonProg"
