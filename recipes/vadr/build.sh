...
chmod 755 ${RECIPE_DIR}/download-vadr-models.sh ${RECIPE_DIR}/run-vadr-local-tests.sh
cp ${RECIPE_DIR}/download-vadr-models.sh ${RECIPE_DIR}/run-vadr-local-tests.sh ${PREFIX}/bin/
