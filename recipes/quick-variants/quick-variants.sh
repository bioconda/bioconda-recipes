#!/bin/bash
# quick-variants executable shell script for https://github.com/caozhichongchong/QuickVariants
set -e
...
runExplain "$java" $jvm_mem_opts $jvm_prop_opts -jar "$JAR_DIR/quick-variants.jar" $pass_args
