...
(cd kent/src/hg/mouseStuff/netClass && make CC="${CC}" CXX="${CXX}" CFLAGS="${CFLAGS}" CXXFLAGS="${CXXFLAGS}" -j "${CPU_COUNT}")
cp bin/netClass "${PREFIX}/bin"
chmod 0755 "${PREFIX}/bin/netClass"
