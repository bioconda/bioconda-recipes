...
export CFLAGS="${CFLAGS} -O3 -DHAVE_LIBDEFLATE"
export CPPFLAGS="${CPPFLAGS} -I${PREFIX}/include -DHAVE_LIBDEFLATE"
...
${PYTHON} -m pip install . --use-pep517 --no-deps --no-cache-dir -vvv
