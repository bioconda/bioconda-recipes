...
(cd kent/src/hg/makeDb/hgTrackDb && make CC="${CC}" CXX="${CXX}" CFLAGS="${CFLAGS}" CXXFLAGS="${CXXFLAGS}" -j "${CPU_COUNT}")
cp bin/hgTrackDb "${PREFIX}/bin"
chmod 0755 "${PREFIX}/bin/hgTrackDb"
