...
if [[ "$(uname -m)" == "arm64" ]]; then
    rsync -aP rsync://hgdownload.cse.ucsc.edu/genome/admin/exe/macOSX.arm64/parasol .
    install -v -m 755 parasol "${PREFIX}/bin"
else
    ...
    install -v -m 755 kent/src/parasol/bin/parasol "${PREFIX}/bin"
fi
