...
(cd kent/src/hg/mouseStuff/chainNet && make CC="${CC}" CXX="${CXX}" CFLAGS="${CFLAGS}" CXXFLAGS="${CXXFLAGS}" -j "${CPU_COUNT}")
cp bin/chainNet "${PREFIX}/bin"
chmod 0755 "${PREFIX}/bin/chainNet"
