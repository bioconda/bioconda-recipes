...
cmake -S .. -B . -G Ninja -DCMAKE_BUILD_TYPE="Release" \
	...
	-DCMAKE_PREFIX_PATH="${PREFIX}" -DCMAKE_INSTALL_PREFIX="${PREFIX}" -DCMAKE_INSTALL_RPATH="${PREFIX}/lib" -DCMAKE_INSTALL_REMOVE_ENVIRONMENT_RPATH=ON -DCMAKE_SKIP_BUILD_RPATH=ON \
