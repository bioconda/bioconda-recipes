...
make --directory misc CFLAGS="${CFLAGS}" CPPFLAGS="${CPPFLAGS}" prefix="${PREFIX}" CC="${CC}" CXX="${CXX} -L${PREFIX}/lib" LDFLAGS+="-lz -lpthread ${LDFLAGS} -L${PREFIX}/lib" HTSSRC="systemwide"
