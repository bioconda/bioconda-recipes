...
if [[ "$(uname)" == "Darwin" ]]; then
    cmake .. \
        ...
        -DOPENGL_gl_LIBRARY:FILEPATH="/System/Library/Frameworks/OpenGL.framework/OpenGL" \
        -DOPENGL_INCLUDE_DIR:PATH="/System/Library/Frameworks/OpenGL.framework/Headers" \
        -DEXPANSION_JS=ON \
        -DEXPANSION_LT=ON \
        -DEXPANSION_GL=ON
elif [[ "$(uname)" == "Linux" ]]; then
