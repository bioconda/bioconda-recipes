...
(cd kent/src/hg/mouseStuff/chainSplit && make CC="${CC}" CXX="${CXX}" CFLAGS="${CFLAGS}" CXXFLAGS="${CXXFLAGS}" -j "${CPU_COUNT}")
cp bin/chainSplit "${PREFIX}/bin"
chmod 0755 "${PREFIX}/bin/chainSplit"
