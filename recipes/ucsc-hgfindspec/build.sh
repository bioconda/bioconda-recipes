...
(cd kent/src/hg/makeDb/hgFindSpec && make CC="${CC}" CXX="${CXX}" CFLAGS="${CFLAGS}" CXXFLAGS="${CXXFLAGS}" -j "${CPU_COUNT}")
cp bin/hgFindSpec "${PREFIX}/bin"
chmod 0755 "${PREFIX}/bin/hgFindSpec"
