...
EOF
elif [ "$(${PREFIX}/share/RepeatMasker/RepeatMasker -help | head 1)" != "RepeatMasker version 4.1.8" ] # check if v4.1.8, only get libs if not, as 4.1.8 comes with minimum library
