...
chmod u+x $SP_DIR/biobb_vs/vina/autodock_vina_run.py
cp $SP_DIR/biobb_vs/vina/autodock_vina_run.py $PREFIX/bin/autodock_vina_run
...
chmod u+x $SP_DIR/biobb_vs/fpocket/fpocket_run.py
cp $SP_DIR/biobb_vs/fpocket/fpocket_run.py $PREFIX/bin/fpocket_run
