...
(cd kent/src/hg/makeDb/hgFakeAgp && make CC="${CC}" CXX="${CXX}" CFLAGS="${CFLAGS}" CXXFLAGS="${CXXFLAGS}" -j "${CPU_COUNT}")
cp bin/hgFakeAgp "${PREFIX}/bin"
chmod 0755 "${PREFIX}/bin/hgFakeAgp"
