...
./configure --with-readline=no --with-x=no --prefix=$PREFIX  --with-iconv-include=$INCLUDE_PATH --with-iconv-lib=$LIBRARY_PATH CFLAGS="$CFLAGS" LDFLAGS="$LDFLAGS" CXXFLAGS="$CXXFLAGS" 
