...
(cd kent/src/hg/mouseStuff/chainSwap && make CC="${CC}" CXX="${CXX}" CFLAGS="${CFLAGS}" CXXFLAGS="${CXXFLAGS}" -j "${CPU_COUNT}")
cp bin/chainSwap "${PREFIX}/bin"
chmod 0755 "${PREFIX}/bin/chainSwap"
