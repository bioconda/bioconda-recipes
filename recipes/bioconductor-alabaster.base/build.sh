...
then
  ...
  export CXXFLAGS="${CXXFLAGS} -std=gnu++17 -D_LIBCPP_DISABLE_AVAILABILITY -DCMAKE_OSX_DEPLOYMENT_TARGET=10.15  -mmacosx-version-min=10.15"
...
FC=$FC
CXX=$CXX
CXXFLAGS= -std=c++17 -D_LIBCPP_DISABLE_AVAILABILITY -DCMAKE_OSX_DEPLOYMENT_TARGET=10.15  -mmacosx-version-min=10.15
CXX98=$CXX
CXX11=$CXX
