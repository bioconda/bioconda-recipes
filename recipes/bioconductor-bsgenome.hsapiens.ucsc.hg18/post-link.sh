#!/bin/bash
FN="BSgenome.Hsapiens.UCSC.hg18_1.3.1000.tar.gz"
URLS=(
  "https://bioconductor.org/packages/3.14/data/annotation/src/contrib/BSgenome.Hsapiens.UCSC.hg18_1.3.1000.tar.gz"
