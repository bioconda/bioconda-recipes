...
make CXX=$CXX CXXFLAGS="-static-libstdc++ ext/htslib-1.11-lowdep/libhts.a -I ext/htslib-1.11-lowdep/ -I $PREFIX/include -pthread -lm -lz -lbz2 -llzma -ldeflate -fPIE" LDFLAGS="-L $PREFIX/lib" && make deploy
