...
(cd kent/src/utils/bigWigCluster && make CC="${CC}" CXX="${CXX}" CFLAGS="${CFLAGS}" CXXFLAGS="${CXXFLAGS}" -j "${CPU_COUNT}")
cp bin/bigWigCluster "${PREFIX}/bin"
chmod 0755 "${PREFIX}/bin/bigWigCluster"
