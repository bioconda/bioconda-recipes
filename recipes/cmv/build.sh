#!/bin/bash
export LIBRARY_PATH="${PREFIX}/lib:/lib:/lib64"
export LD_LIBRARY_PATH="${PREFIX}/lib:/lib:/lib64"
export LDFLAGS="-L${PREFIX}/lib -pthread -lpthread"
export CPPFLAGS="-I${PREFIX}/include"
export GCCPATH=$PREFIX/bin/gcc

stack setup --with-gcc="$GCCPATH" --extra-include-dirs ${PREFIX}/include --extra-lib-dirs=[${PREFIX}/lib,/lib,/lib64] --local-bin-path ${PREFIX}/bin
stack update
