...
cmake -S . -B build -DCMAKE_BUILD_TYPE=Release \
	...
	-DBLAST_INCLUDE_DIR="${PREFIX}/include" -DBLAST_LIBRARY_DIR="${PREFIX}/lib/ncbi-blast+" \
	-DEXTRA=ON -DDP_STAT=ON -DWITH_DNA=ON -DWITH_MCL=ON -Wno-dev -Wno-deprecated --no-warn-unused-cli \
	"${CONFIG_ARGS}"
